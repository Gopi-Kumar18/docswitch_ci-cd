...
export const removePass = async (req, res) => {
  let inputFilePath;
  ...
  try {
    ...
    const params = new RemoveProtectionParams({ password });
    ...
    const uniqueName   = `${baseName}_unprotected_${crypto.randomBytes(4).toString('hex')}.pdf`;
    ...
    console.error('Remove protection error:', err);
